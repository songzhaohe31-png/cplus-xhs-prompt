...
function isBlocked(url) {
  ...
  if (u === '/api/agent/chat' || u === '/api/agent/rewrite' || u === '/api/agent/chat/stream') return false;
  if (u === '/api/agent/batch' || u === '/api/agent/jobs' || u.startsWith('/api/agent/jobs/')) return false;
  if (u === '/api/bootstrap' || u === '/api/readiness' || u === '/api/dna' || u.startsWith('/api/dna/')) return false;
  if (u === '/api/knowledge/upload' || /\/api\/knowledge\/[^/]+\/preview$/.test(u)) return false;
